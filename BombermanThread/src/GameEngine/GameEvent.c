/*
** GameEven.c for Bomberman
** 
** Made by YOUBI David on 06/06/2017
** login <youbi_d@etna-alternance.net>
**
** Started on 06 juin 11:27 2017 dyoubi
** Last update 06 juin 11:27 2017 dyoubi
*/

#include "GameEvent.h"

bool GameMenuHandler(SDL_Event *p_event, t_menu *p_menu) {
    static bool keepRun;
...
bool GameLoopHandler(SDL_Event *p_event, t_menu *p_menu) {
    static bool keepRun;
    static bool trigerMenu;
...
bool GameHandler(SDL_Event *p_event, t_menu *p_menu){
    if(p_menu->showMenu){
     return GameMenuHandler(p_event, p_menu);
    } else {
        return GameLoopHandler(p_event, p_menu);
    }
}